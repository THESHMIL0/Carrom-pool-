class Renderer {
    ...
    drawBoard() {
        ...
        this.ctx.beginPath(); this.ctx.moveTo(200, 150); this.ctx.lineTo(600, 150); this.ctx.stroke(); 
        this.ctx.beginPath(); this.ctx.moveTo(200, 650); this.ctx.lineTo(600, 650); this.ctx.stroke(); 
